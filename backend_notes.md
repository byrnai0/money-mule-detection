...
Only **5,177** transactions are labelled as laundering, which means the dataset is **heavily imbalanced**.
...
- ⚠️ there are only **9** actual exact duplicate transaction records  
...
- Phase 2 → Cleaning duplicate records (in progress)  
...
- [x] Project research collected  
- [x] Dataset selected  
- [x] Loader implemented  
- [x] Dataset loaded  
- [x] Dataset profiled  
- [x] Data validated  
- [ ] Remove exact duplicates *(in progress)*  
- [ ] Build account graph  
